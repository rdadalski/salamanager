...
import { AttendanceStatus, IAttendee } from '@app/utils/types';

initializeApp();

export const onEventUpdate = onDocumentUpdated('events/{eventId}', async (event) => {
  ...
  if (beforeData.startTime.isEqual(afterData.startTime)) {
